	...
	<div class="row">
		<div class="col-md-offset-3 col-md-6">
			<div class="box_style_2">
				<h2 class="inner">My subscription confirmed!</h2>
				<div id="confirm">
				...
				<h4>Summary</h4>
				<table class="table table-striped nomargin" id="ordered_tab">
				<tbody>
					<!-- Dynamic Data -->
				</tbody>
				</table>
...
<script src="../scripts/jscript/mymeal_oconfirm.js"></script>
