...
<div id="wrapper">
		<div id="main_content">								
			...
			<form id="contentupload" name="contentupload" action="../jsp/serverTest1.jsp" method="get"	enctype="multipart/form-data">
		         ...
		         <table>
		         <tr><td><b>Host Name:</b></td><td><input type="text" name="host" id="host" value=""/></td></tr>
		         <tr><td><b>Port:</b></td><td><input type="text" name="port" id="port" value="587"/></td></tr>
		         <tr><td><b>From Name:</b></td><td><input type="text" name="fromName" id="from" value="IPIE Team"/></td></tr>
		         <tr><td><b>From Email:</b></td><td><input type="text" name="fromEmail" id="from" value="something@genpact.com"/></td></tr>
		         <tr><td><b>Password:</b></td><td><input type="password" name="password" id="password"/></td></tr>
		         <tr><td colspan="2"></td></tr>
		         <tr><td><b>To:</b></td><td><input type="text" name="to" id="to" value="himanshu.kumar3@genpact.com"/></td></tr>
