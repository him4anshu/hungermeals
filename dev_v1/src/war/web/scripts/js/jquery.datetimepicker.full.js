...
;(function (factory) {
	...
	$.fn.datetimepicker = function (opt) {
		...
		createDateTimePicker = function (input) {
			...
			setPos = function () {
				var offset = datetimepicker.data('input').offset(), datetimepickerelement = datetimepicker.data('input')[0], top = offset.top + datetimepickerelement.offsetHeight - 10, left = offset.left , position = "absolute", node;
