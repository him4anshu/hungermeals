...
<!-- SubHeader =============================================== -->
<section class="parallax-window" id="short" data-parallax="scroll" data-image-src="../images/addr.jpg" data-natural-width="1400" data-natural-height="350">
    <div id="subheader">
    	<div id="sub_content">
...
<div class="container margin_80_35">
	<div id="container_pin">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="box_style_2" id="order_process_time">
					<h2 class="inner">Your delivery slot</h2>
					<div class="row" id="select_delivery_slot">
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								<label>Choose date:</label>
								<div id="deliveryDay"></div>
								<input type="hidden" id="alt_sel_dates" hidden />						
							</div>
						</div>
						<div class="col-md-6 col-sm-6">
							<div class="form-group">
								...
								<select class="form-control" id="deliveryTime" disabled="">
									<option value="-1" disabled selected>Select time-slot</option>
								</select>
							</div>
						</div>
					</div>					
...
<!-- 							<input type="text" id="address_order" name="HM_address1" class="form-control" placeholder=" Your address"> -->	
		                    <div class="styled-select">
		                        <select class="form-control" name="HM_address1" id="address_order">
		                        	<option selected="selected" value="-1">Select locality</option>	
...
<!-- 							<input type="text" id="address_order" name="HM_address2" class="form-control" placeholder=" Your address"> -->
						...
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label>City</label>
									<input type="text" id="city_order" name="HM_city" class="form-control" placeholder="Your city" disabled="">
								</div>
							</div>
							<div class="col-md-6 col-sm-6">
								<div class="form-group">
									<label>Pin code</label>
									<input type="text" id="pcode_oder" name="HM_pcode" class="form-control" placeholder=" Your pin code" onkeypress='return event.charCode >= 48 && event.charCode <= 57' maxlength="6" disabled="">
								</div>
							</div>
						</div>
						<div class="row">
			...
			<div class="col-md-3">
				<div id="cart_box">
					...
					<a class="btn_full_outline" href="index.html"><i class="icon-right"></i> Add more items</a>
				</div><!-- End cart_box -->
			</div><!-- End col-md-3 -->
...
<script src="../scripts/jscript/addr.js"></script>
