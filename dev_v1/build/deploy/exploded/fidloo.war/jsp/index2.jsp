...
<head>
    ...
    <link href="../scripts/css/g_api.css" rel="stylesheet">
</head>
            ...
            <div id="custom-search-input">
                <div class="input-group search-group">
                    <div class="search_div">
			            <p>
			               <h3>Check our delivery presence near you.</h3>
			            </p>
	                    <input type="text" class="search-query" id="search_loc" placeholder="Search your locality">
                    	<label>or <a href="#0" onclick="getLocation();">my location</a></label>
                    	<br><span class="search-result"></span>
                    </div>
...
<script src="../scripts/jscript/g_api.js"></script>
